...
AMD64_VERSION=$(curl -s 'https://www.syncovery.com/linver_RS-x86_64.tar.gz.txt' 2> /dev/null)
ARM64_VERSION=$(curl -s 'https://www.syncovery.com/linver_RS-aarch64.tar.gz.txt' 2> /dev/null)
